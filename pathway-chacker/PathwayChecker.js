document.addEventListener("DOMContentLoaded",function(){const explorerIdInput=document.getElementById("explorer-id-input");const loadingElement=document.getElementById("loading");const errorElement=document.getElementById("error-message");const errorTextElement=document.getElementById("error-text");const dashboardContainer=document.getElementById("dashboard-container");const SCRIPT_URL="https://script.google.com/macros/s/AKfycbx_DxD20Exi62uqA1RiYRrT53rtaUatb_v3t2sAq5FeUlsoyHjoZgrpLgh9n63R3b_1SQ/exec";function getExplorerIdFromHash(){try{return window.location.hash?decodeURIComponent(window.location.hash.substring(1)):null}catch(e){console.error("Error decoding hash:",e);return null}}
